...
def jwt_payload(user, context=None):
    ...
    payload['https://hasura.io/jwt/claims']['x-hasura-allowed-roles'] = [user.username]   # [user.profile.role]
    payload['https://hasura.io/jwt/claims']['x-hasura-default-role'] = user.username      # user.profile.role
