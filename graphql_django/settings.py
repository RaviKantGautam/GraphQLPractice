...
SECRET_KEY = 'django-insecure-u=1nbi7@@^=&txs093@ezaqjxtro&qs%p!_ke--#w!z=cw+-a4'
...
GRAPHENE = {
    ...
    # "SCHEMA": "inventory.schemarelay.schema",
    'MIDDLEWARE': [
...
GRAPHQL_JWT = {
    'JWT_PAYLOAD_HANDLER': 'authentication.utils.jwt_payload',
